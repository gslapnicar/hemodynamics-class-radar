...
[PCG_Features, featuresFs] = getSpringerPCGFeatures(audio_data, Fs, figures); % Show figures

%% Get PCG heart rate

[heartRate, systolicTimeInterval] = getHeartRateSchmidt(audio_data, Fs, figures); % Show figures

[~, ~, qt] = viterbiDecodePCG_Springer(PCG_Features, pi_vector, B_matrix, total_observation_distribution, heartRate, systolicTimeInterval, featuresFs, figures); % Show figures
