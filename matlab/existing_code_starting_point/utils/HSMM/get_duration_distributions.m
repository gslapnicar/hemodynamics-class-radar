...
mean_S1 = round(0.122*springer_options.audio_segmentation_Fs); % Edited Kilin 16.09.2019
std_S1 = round(0.022*springer_options.audio_segmentation_Fs); % Edited Kilin 16.09.2019
mean_S2 = round(0.094*springer_options.audio_segmentation_Fs); % Edited Kilin 16.09.2019
std_S2 = round(0.022*springer_options.audio_segmentation_Fs); % Edited Kilin 16.09.2019
...
std_diastole_var = springer_options_advanced.std_diastole_var;
...
std_diastole = std_diastole_var*mean_diastole + (6/1000)*springer_options.audio_segmentation_Fs; % Edited Kilin 28.03.2017
